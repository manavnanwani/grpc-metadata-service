...
func (x *DataResponse) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
var file_proto_metadata_metadata_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x09, 0x0a, 0x07, 0x4e, 0x6f, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x22, 0x54, 0x0a, 0x0c,
	...
	0x6f, 0x6e, 0x32, 0x57, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x19, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x4e, 0x6f, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x1a, 0x1e, 0x2e, 0x6d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44,
	0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x12, 0x5a, 0x10, 0x2e,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x62,
...
var file_proto_metadata_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_metadata_metadata_proto_goTypes = []interface{}{
	(*NoParam)(nil),      // 0: metadata_service.NoParam
	(*DataResponse)(nil), // 1: metadata_service.DataResponse
}
var file_proto_metadata_metadata_proto_depIdxs = []int32{
	0, // 0: metadata_service.MetadataService.GetData:input_type -> metadata_service.NoParam
	1, // 1: metadata_service.MetadataService.GetData:output_type -> metadata_service.DataResponse
...
func file_proto_metadata_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_metadata_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_metadata_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
